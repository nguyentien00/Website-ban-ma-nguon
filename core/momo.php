...
$tran_code = db_escape(addslashes(htmlentities(GET('code', ENT_QUOTES, "UTF-8"))));
...
if (! function_exists('imap_open')) {
  ...
  $connection = imap_open('{imap.gmail.com:993/imap/ssl/novalidate-cert}INBOX', 'thuecodeweb.net@gmail.com', 'DatLight123@') or die('Cannot connect to Gmail: ' . imap_last_error());
    ...
    foreach ($emailData as $emailIdent) {
      ...
      if ($tran_code == $code) {
        echo json_encode([
          'result' => 200,
          'status' => 'success',
          'msg' => 'Xác minh giao dịch Thành Công!',
          'money' => $money,
          'code' => $code,
          'name' => $name,
          'phone' => $phone,
